...
MapTo('private-base-site/components/download')(DownloadV1Component,{isEmpty: DownloadV1IsEmptyFn});
MapTo('private-base-site/components/languagenavigation')(LanguageNavigationV1Component);
MapTo('private-base-site/components/list')(ListV2Component, {isEmpty: ListV2IsEmptyFn});
MapTo('private-base-site/components/breadcrumb')(BreadCrumbV2Component, {isEmpty: BreadCrumbV2IsEmptyFn})
MapTo('private-base-site/components/button')(ButtonV1Component, {isEmpty: ButtonV1IsEmptyFn});
MapTo('private-base-site/components/image')(ImageV2Component, {isEmpty: ImageV2IsEmptyFn});

MapTo('private-base-site/components/carousel')(CarouselV1Component);
MapTo('private-base-site/components/accordion')(AccordionV1Component);
MapTo('private-base-site/components/tabs')(TabsV1Component);
